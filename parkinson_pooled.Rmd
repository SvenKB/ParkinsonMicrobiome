...
ggplot(data=full.dat,aes(x=author,y=Firmicutes+1,fill=status)) +
  geom_boxplot() +
  scale_x_discrete(labels=addline_format(unique(alpha_dat$author)))
...
## Non-parametric univariate permutation tests
